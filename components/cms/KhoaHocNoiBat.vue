            ...
            <div class="w-[40%]">
              <nuxt-link :to="course.link">
                <button
                  ...
                  class="bg-[#6046FF] text-white ml-3 text-sm rounded-md font-thin px-2 py-0.5 text-center block hover:bg-sky-500"
                >
                  Mua ngay
                </button>
                <button
      ...
      >
        ...
        <div class="w-full">
          <div class="h-full pr-8 overflow-y-auto">
            ...
            <h2 class="text-2xl font-semibold mb-4">Ẩn phần này:</h2>
            <label v-if="anComponent" class="toggle" for="toggle">
              <input
                id="toggle"
                type="checkbox"
                class="toggle-input"
                ...
                v-model="anComponent"
              />
              <div class="toggle-main" :class="{ active: isChecked }">
        ...
        <div class="">
          <n-modal v-model:show="editAdd">
            ...
            >
              <template #header-extra> {{ title + " " + subTitle }}</template>
              <div class="h-full pr-8 overflow-y-auto">
                <!-- <b class="flex text-2xl text-green-500 items-center mb-8"
                  >Thêm mới khóa học</b
                > -->
                <div class="mb-4">
                  <label for="editImage" class="block font-semibold"
